...
import { getRitual } from "../../utopia/data/rituals";
import type { RitualId } from "../../utopia/types";

type RitualInfoProps = {
    ritualId: RitualId;
};
...
export function RitualInfo({ ritualId }: RitualInfoProps) {
    ...
    return (
        ...
        >
            <button
                ...
                aria-label={`Show info for ${ritual.display}`}
                title={`Show info for ${ritual.display}`}
            ...
            {open && (
                ...
                >
                    <div className="entity-info-title">{ritual.display}</div>
                    ...
                    <div className="entity-info-section">
                        <div className="entity-info-section-label">Note</div>
                        <div>Apply ritual effectiveness on top of these base values.</div>
                    </div>
                </div>
            )}
        </span>
